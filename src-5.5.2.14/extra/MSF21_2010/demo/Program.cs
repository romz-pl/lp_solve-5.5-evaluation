...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        static void Example3()
        {
            ...
            Console.WriteLine("GetShadowPrices:");
            foreach (Constraint constraint in model.Constraints)
                foreach (KeyValuePair<string, Rational> o in lpReport.GetShadowPrices(constraint))
                    Console.WriteLine("Key: " + o.Key + ", Value: " + o.Value.ToDouble().ToString());
            ...
            Console.WriteLine("GetConstraintBoundsSensitivity:");
            foreach (Constraint constraint in model.Constraints)
                foreach (KeyValuePair<string, LinearSolverSensitivityRange> o in lpReport.GetConstraintBoundsSensitivity(constraint))
                    Console.WriteLine("Key: " + o.Key + ", Current: " + o.Value.Current.ToDouble().ToString() + ", Value.Lower: " + o.Value.Lower.ToDouble().ToString() + ", Value.Upper: " + o.Value.Upper.ToDouble().ToString());
