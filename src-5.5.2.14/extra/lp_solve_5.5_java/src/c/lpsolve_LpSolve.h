...
/*
 * Class:     lpsolve_LpSolve
 * Method:    getBreakNumericAccuracy
 * Signature: ()D
 */
JNIEXPORT jdouble JNICALL Java_lpsolve_LpSolve_getBreakNumericAccuracy
  (JNIEnv *, jobject);
 ...
 * Signature: ()D
 */
JNIEXPORT jdouble JNICALL Java_lpsolve_LpSolve_getAccuracy
  (JNIEnv *, jobject);
