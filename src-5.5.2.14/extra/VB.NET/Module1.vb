...
Module Module1
    ...
    Private Sub logfunc(ByVal lp As IntPtr, ByVal userhandle As Integer, ByVal Buf As String)

        System.Diagnostics.Debug.Write(Buf)

    End Sub

    Private Function ctrlcfunc(ByVal lp As IntPtr, ByVal userhandle As Integer) As Integer
    ...
    Private Sub msgfunc(ByVal lp As IntPtr, ByVal userhandle As Integer, ByVal message As lpsolve55.lpsolve_msgmask)
