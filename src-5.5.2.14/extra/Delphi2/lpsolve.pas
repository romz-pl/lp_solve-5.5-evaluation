...
{$IFDEF LPS55_UP}
  ...
  PRICE_future1         =  8192;    (* Future option *)
  PRICE_future2         = 16384;    (* Future option *)
{$ELSE}
...
function read_MPS(filename: PChar; options: integer): THandle; stdcall; overload;
...
function read_freeMPS(filename: PChar; options: Integer): THandle; stdcall; overload;
...
function read_MPS(filename: PChar; options: integer): THandle; stdcall; external LPSOLVELIB name 'read_MPS';
function read_mps(stream: PInteger; options: integer): THandle; stdcall; external LPSOLVELIB name 'read_mps';
function read_freeMPS(filename: PChar; options: Integer): THandle; stdcall; external LPSOLVELIB name 'read_freeMPS';
