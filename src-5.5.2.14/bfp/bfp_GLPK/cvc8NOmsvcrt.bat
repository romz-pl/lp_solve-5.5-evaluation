...
%c% -I.. -I../.. -I../../colamd -I../../shared -I%glpkdir%\include /LD /MT /O2 /Zp8 /Gz -D_WINDLL -D_USRDLL -DWIN32 -DRoleIsExternalInvEngine -DINVERSE_ACTIVE=INVERSE_GLPKLU -D_CRT_SECURE_NO_DEPRECATE %src% /Febin\%PLATFORM%\bfp_GLPK.dll
...
rem mt /outputresource:"bin\%PLATFORM%\bfp_GLPK.dll;#2" /manifest "bin\%PLATFORM%\bfp_GLPK.dll.manifest"
