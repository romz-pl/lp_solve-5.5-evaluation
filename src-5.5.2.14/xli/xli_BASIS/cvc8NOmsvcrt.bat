...
set src=../../shared/commonlib.c xli_BASIS.c lp_BASIS.c lp_BASIS1.c lp_Hash1.c lp_SOS1.c ../../lp_utils.c

%c% -I.. -I../.. -I../../shared /LD /MT /Zp8 /Gz -D_WINDLL -D_USRDLL -DWIN32 -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE %src% ../lp_XLI.def /Febin\%PLATFORM%\xli_BASIS.dll
...
rem mt /outputresource:"bin\%PLATFORM%\xli_BASIS.dll;#2" /manifest "bin\%PLATFORM%\xli_BASIS.dll.manifest"
