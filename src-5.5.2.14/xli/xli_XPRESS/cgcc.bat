...
%c% -DINLINE=static -I.. -I../.. -I../../shared -s -O3 -shared -mno-cygwin -enable-stdcall-fixup -D_WINDLL -D_USRDLL -DWIN32 -DYY_NEVER_INTERACTIVE %src% ../lp_XLI.def -o bin\%PLATFORM%\xli_XPRESS.dll

%c% -DINLINE=static -I.. -I../.. -I../../shared -s -O3 -shared -D_WINDLL -D_USRDLL -DWIN32 -DYY_NEVER_INTERACTIVE %src% ../lp_XLI.def -o bin\%PLATFORM%\libxli_XPRESS.so

%c% -DINLINE=static -I.. -I../.. -I../../shared -s -O3 -c -DYY_NEVER_INTERACTIVE %src%
ar rv bin\%PLATFORM%\libxli_XPRESS.a *.o
