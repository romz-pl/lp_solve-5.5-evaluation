 ...
 * -------------------------------------------------------------------------
 */
static int __cdecl subset_cmp(const void* a, const void* b)
{
...
static int __cdecl order_cmp(const void* a, const void* b)
{
   const int* aa = (const int*)a;
   const int* bb = (const int*)b;
 ...
 * -------------------------------------------------------------------------
 */
static int __cdecl subset_idx_cmp(const void* a, const void* b)
{
...
static int __cdecl order_idx_cmp(const void* a, const void* b)
{
   const int* key   = (const int*)a;
