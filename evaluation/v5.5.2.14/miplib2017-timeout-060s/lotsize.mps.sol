...
Optimal solution             3431356 after     502662 iter,     54175 nodes (gap 884.9%).

Relative numeric accuracy ||*|| = 1.1345e-12

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 502662, 6769 (1.3%) were bound flips.
      There were 27009 refactorizations, 0 triggered by time and 0 by density.
       ... on average 18.4 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 4757 NZ entries, 1.0x largest basis.
      The maximum B&B level was 232, 0.1x MIP order, 212 at the optimal solution.
...
Value of objective function: 3431355.99999999
