...
Optimal solution                  69 after    1166734 iter,    549077 nodes (gap 1066.7%).

Relative numeric accuracy ||*|| = 2.84217e-13

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 1166734, 0 (0.0%) were bound flips.
      There were 277086 refactorizations, 0 triggered by time and 2 by density.
       ... on average 4.2 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 945 NZ entries, 1.0x largest basis.
      The maximum B&B level was 94, 0.2x MIP order, 70 at the optimal solution.
