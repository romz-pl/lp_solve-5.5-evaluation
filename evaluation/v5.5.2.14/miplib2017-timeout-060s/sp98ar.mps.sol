...
Optimal solution        617260739.52 after     270207 iter,     58482 nodes (gap 17.7%).

Relative numeric accuracy ||*|| = 2.22045e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 270207, 66282 (24.5%) were bound flips.
      There were 29239 refactorizations, 0 triggered by time and 22 by density.
       ... on average 7.0 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 5847 NZ entries, 1.0x largest basis.
      The maximum B&B level was 218, 0.0x MIP order, 110 at the optimal solution.
      The constraint matrix inf-norm is 28, with a dynamic range of 28.
      Time to load data was 0.122 seconds, presolve used 0.091 seconds,
       ... 59.910 seconds in simplex solver, in total 60.123 seconds.
Suboptimal solution

Value of objective function: 617260739.51997387
