...
Optimal solution                 213 after    3347558 iter,    317419 nodes (gap 16.1%).

Relative numeric accuracy ||*|| = 1.4803e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 3347558, 531409 (15.9%) were bound flips.
      There were 158979 refactorizations, 0 triggered by time and 289 by density.
       ... on average 17.7 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 5574 NZ entries, 1.9x largest basis.
      The maximum B&B level was 57, 0.2x MIP order, 27 at the optimal solution.
