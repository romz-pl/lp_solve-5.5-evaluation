...
Optimal solution               55595 after     290837 iter,     28627 nodes (gap 5.4%).

Relative numeric accuracy ||*|| = 1.11022e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 290837, 40090 (13.8%) were bound flips.
      There were 14720 refactorizations, 0 triggered by time and 0 by density.
       ... on average 17.0 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 7359 NZ entries, 1.0x largest basis.
      The maximum B&B level was 86, 0.0x MIP order, 52 at the optimal solution.
      ...
      Time to load data was 0.013 seconds, presolve used 0.007 seconds,
       ... 59.994 seconds in simplex solver, in total 60.014 seconds.
Suboptimal solution
