...
Optimal solution         -2.29378062 after     275078 iter,      5607 nodes (gap 3.6%).

Relative numeric accuracy ||*|| = 7.77156e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 275078, 172879 (62.8%) were bound flips.
      There were 2813 refactorizations, 0 triggered by time and 3 by density.
       ... on average 36.3 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 1169 NZ entries, 1.0x largest basis.
      The maximum B&B level was 34, 0.3x MIP order, 29 at the optimal solution.
      The constraint matrix inf-norm is 10, with a dynamic range of 10.
      Time to load data was 0.039 seconds, presolve used 0.014 seconds,
       ... 59.988 seconds in simplex solver, in total 60.041 seconds.
Suboptimal solution
