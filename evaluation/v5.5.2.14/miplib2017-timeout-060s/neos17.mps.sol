...
Optimal solution      0.219685034965 after    1201651 iter,    118298 nodes (gap 21.9%).

Relative numeric accuracy ||*|| = 1.6628e-15

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 1201651, 8971 (0.7%) were bound flips.
      There were 82086 refactorizations, 0 triggered by time and 3 by density.
       ... on average 14.5 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 3053 NZ entries, 1.0x largest basis.
      The maximum B&B level was 179, 0.3x MIP order, 173 at the optimal solution.
      ...
      Time to load data was 0.008 seconds, presolve used 0.001 seconds,
       ... 60.000 seconds in simplex solver, in total 60.009 seconds.
Suboptimal solution
