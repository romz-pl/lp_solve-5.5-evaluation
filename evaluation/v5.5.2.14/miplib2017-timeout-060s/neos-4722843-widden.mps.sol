...
Optimal solution       33141.9069307 after      13229 iter,       616 nodes (gap 2165.4%).

Relative numeric accuracy ||*|| = 2.81403e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 13229, 404 (3.1%) were bound flips.
      There were 389 refactorizations, 0 triggered by time and 0 by density.
       ... on average 33.0 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 194523 NZ entries, 1.0x largest basis.
      The maximum B&B level was 86, 0.0x MIP order, 80 at the optimal solution.
      The constraint matrix inf-norm is 100000, with a dynamic range of 1e+06.
      Time to load data was 0.395 seconds, presolve used 0.136 seconds,
       ... 59.874 seconds in simplex solver, in total 60.405 seconds.
Suboptimal solution

Value of objective function: 33141.90693069
