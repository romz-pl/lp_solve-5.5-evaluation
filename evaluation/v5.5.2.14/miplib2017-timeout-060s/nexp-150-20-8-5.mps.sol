...
Optimal solution                 615 after     151812 iter,     19344 nodes (gap 2980.0%).

Relative numeric accuracy ||*|| = 1.18424e-15

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 151812, 1766 (1.2%) were bound flips.
      There were 9673 refactorizations, 0 triggered by time and 0 by density.
       ... on average 15.5 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 6901 NZ entries, 1.0x largest basis.
      The maximum B&B level was 319, 0.0x MIP order, 209 at the optimal solution.
