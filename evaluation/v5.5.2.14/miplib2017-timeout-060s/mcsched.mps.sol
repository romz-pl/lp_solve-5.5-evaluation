...
Optimal solution              212833 after     515378 iter,     17737 nodes (gap 9.8%).

Relative numeric accuracy ||*|| = 7.77156e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 515378, 58313 (11.3%) were bound flips.
      There were 9208 refactorizations, 0 triggered by time and 330 by density.
       ... on average 49.6 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 8565 NZ entries, 1.1x largest basis.
      The maximum B&B level was 37, 0.0x MIP order, 23 at the optimal solution.
