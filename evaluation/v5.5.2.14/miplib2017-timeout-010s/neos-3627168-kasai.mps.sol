...
Optimal solution           1018229.4 after      23721 iter,     14206 nodes (gap 7.7%).

Relative numeric accuracy ||*|| = 8.61249e-12

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 23721, 503 (2.1%) were bound flips.
      There were 7041 refactorizations, 0 triggered by time and 2 by density.
       ... on average 3.3 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 4336 NZ entries, 1.1x largest basis.
      The maximum B&B level was 156, 0.1x MIP order, 141 at the optimal solution.
      ...
      Time to load data was 0.008 seconds, presolve used 0.004 seconds,
       ... 9.997 seconds in simplex solver, in total 10.009 seconds.
Suboptimal solution
