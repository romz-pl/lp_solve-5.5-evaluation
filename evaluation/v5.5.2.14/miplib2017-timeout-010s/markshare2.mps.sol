...
Optimal solution                  34 after    1150632 iter,    453437 nodes (gap 3400.0%).

Relative numeric accuracy ||*|| = 3.0664e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 1150632, 381061 (33.1%) were bound flips.
      There were 227608 refactorizations, 0 triggered by time and 1033 by density.
       ... on average 3.4 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 50 NZ entries, 1.0x largest basis.
      The maximum B&B level was 61, 0.5x MIP order, 43 at the optimal solution.
