...
lp_solve unsuccessful after 3125 iter and a last best value of 1e+30

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 3125, 548 (17.5%) were bound flips.
      There were 11 refactorizations, 0 triggered by time and 0 by density.
       ... on average 234.3 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 50485 NZ entries, 1.0x largest basis.
      The maximum B&B level was 1, 0.0x MIP order, with 0 nodes explored.
      The constraint matrix inf-norm is 226, with a dynamic range of 226.
      Time to load data was 0.494 seconds, presolve used 0.182 seconds,
       ... 9.821 seconds in simplex solver, in total 10.497 seconds.
Timeout
