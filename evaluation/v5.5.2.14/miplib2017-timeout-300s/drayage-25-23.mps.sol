...
b(c4562) = 7319.00000000                b(c798) = -48541.71455383
b(c4517) = 8285.00000000                b(c795) = -48460.11463165

Model name:  'drayage-25-23' - run #1    
...
Presolve O:2 -> Reduced rows:   53, cols:    0 --- changed bnds:    0, Ab:    0.
PRESOLVE             Elimination loops performed.......... O4:M4:I6
                 313 empty or redundant constraints....... REMOVED.
                 130 bounds............................... TIGHTENED.
                     [           +0 < Z < +1.41184e+07 ]
 
REDUCED
Model size:     4317 constraints,   11090 variables,        38478 non-zeros.
Sets:                                   0 GUB,                  0 SOS.
Row-types:         0 LE,             4107 GE,                 210 EQ.
 
Using DUAL simplex for phase 1 and PRIMAL simplex for phase 2.
The primal and dual simplex pricing strategy set to 'Devex'.
 

Relaxed solution       11714.1419792 after      19903 iter is B&B base.
 

lp_solve optimization was stopped due to time-out.
lp_solve unsuccessful after 491443 iter and a last best value of 1e+30
lp_solve explored 3709 nodes before termination

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 491443, 166351 (33.8%) were bound flips.
      There were 14381 refactorizations, 0 triggered by time and 0 by density.
       ... on average 22.6 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 7234 NZ entries, 1.0x largest basis.
      The maximum B&B level was 410, 0.0x MIP order, with 3709 nodes explored.
      The constraint matrix inf-norm is 60000, with a dynamic range of 60000.
      Time to load data was 0.028 seconds, presolve used 0.015 seconds,
       ... 299.987 seconds in simplex solver, in total 300.030 seconds.
Timeout
