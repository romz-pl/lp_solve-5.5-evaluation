...
Optimal solution         7548.495838 after     906011 iter,     26886 nodes (gap 41.7%).

Relative numeric accuracy ||*|| = 2.36848e-15

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 906011, 5354 (0.6%) were bound flips.
      There were 16751 refactorizations, 0 triggered by time and 0 by density.
       ... on average 53.8 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 8141 NZ entries, 1.0x largest basis.
