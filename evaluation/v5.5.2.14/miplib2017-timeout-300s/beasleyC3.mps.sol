...
Optimal solution                 832 after    2123840 iter,    488718 nodes (gap 1883.3%).

Relative numeric accuracy ||*|| = 1.09912e-14

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 2123840, 17837 (0.8%) were bound flips.
      There were 247557 refactorizations, 0 triggered by time and 1 by density.
       ... on average 8.5 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 3249 NZ entries, 1.0x largest basis.
      The maximum B&B level was 209, 0.1x MIP order, 172 at the optimal solution.
