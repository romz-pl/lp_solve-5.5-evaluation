...
Optimal solution            36.38473 after    1281986 iter,     55998 nodes (gap 235.5%).

Relative numeric accuracy ||*|| = 0

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 1281986, 6755 (0.5%) were bound flips.
      There were 34844 refactorizations, 0 triggered by time and 0 by density.
       ... on average 36.6 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 10730 NZ entries, 1.0x largest basis.
