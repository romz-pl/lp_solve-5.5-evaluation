...
Optimal solution               15747 after    2944240 iter,    267776 nodes (gap 177.3%).

Relative numeric accuracy ||*|| = 8.8691e-14

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 2944240, 26973 (0.9%) were bound flips.
      There were 143977 refactorizations, 0 triggered by time and 0 by density.
       ... on average 20.3 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 2643 NZ entries, 1.0x largest basis.
      The maximum B&B level was 129, 0.1x MIP order, 7 at the optimal solution.
