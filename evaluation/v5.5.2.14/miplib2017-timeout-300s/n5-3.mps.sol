...
Optimal solution               10323 after    2776247 iter,    286073 nodes (gap 257.9%).

Relative numeric accuracy ||*|| = 4.73695e-15

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 2776247, 113192 (4.1%) were bound flips.
      There were 144117 refactorizations, 0 triggered by time and 2 by density.
       ... on average 18.5 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 4952 NZ entries, 1.1x largest basis.
      The maximum B&B level was 63, 0.2x MIP order, 43 at the optimal solution.
