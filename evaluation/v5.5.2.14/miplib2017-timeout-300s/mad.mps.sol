...
Improved solution             0.8992 after    1048385 iter,    286190 nodes (gap 89.9%)
Improved solution             0.8988 after    2886162 iter,    772769 nodes (gap 89.9%)
Improved solution              0.861 after    2887348 iter,    773080 nodes (gap 86.1%)
Improved solution             0.8142 after    2953658 iter,    788849 nodes (gap 81.4%)
Improved solution               0.79 after    2961154 iter,    790740 nodes (gap 79.0%)
Improved solution             0.7752 after    3070913 iter,    817850 nodes (gap 77.5%)
Improved solution               0.74 after    3078478 iter,    819778 nodes (gap 74.0%)
Improved solution             0.7244 after    3253809 iter,    861861 nodes (gap 72.4%)
Improved solution              0.683 after    3260547 iter,    863428 nodes (gap 68.3%)
Improved solution              0.664 after    3262620 iter,    863931 nodes (gap 66.4%)
Improved solution              0.656 after    3279956 iter,    867301 nodes (gap 65.6%)
Improved solution             0.6248 after    3429898 iter,    897246 nodes (gap 62.5%)
Improved solution              0.578 after    3440226 iter,    899649 nodes (gap 57.8%)
Improved solution              0.556 after   12038087 iter,   2561865 nodes (gap 55.6%)
Improved solution             0.5516 after   12038642 iter,   2561968 nodes (gap 55.2%)
Improved solution              0.528 after   15781263 iter,   3257074 nodes (gap 52.8%)
Improved solution             0.4888 after   18843545 iter,   3824832 nodes (gap 48.9%)
Improved solution             0.4864 after   18844473 iter,   3825066 nodes (gap 48.6%)
Improved solution             0.4658 after   19399175 iter,   3929354 nodes (gap 46.6%)
Improved solution             0.4478 after   19642650 iter,   3974498 nodes (gap 44.8%)
Improved solution             0.4184 after   20031908 iter,   4051075 nodes (gap 41.8%)
Improved solution             0.4136 after   20318199 iter,   4105080 nodes (gap 41.4%)
Improved solution              0.412 after   20320915 iter,   4105603 nodes (gap 41.2%)
Improved solution              0.364 after   20354432 iter,   4111441 nodes (gap 36.4%)
Improved solution               0.36 after   20361174 iter,   4112491 nodes (gap 36.0%)
Improved solution              0.353 after   20363465 iter,   4112802 nodes (gap 35.3%)
Improved solution              0.323 after   20660194 iter,   4162497 nodes (gap 32.3%)
Improved solution               0.27 after   20669869 iter,   4164194 nodes (gap 27.0%)
Improved solution             0.2698 after   21404885 iter,   4275953 nodes (gap 27.0%)
Improved solution             0.2552 after   21556344 iter,   4300945 nodes (gap 25.5%)
Improved solution               0.22 after   23329141 iter,   4568831 nodes (gap 22.0%)
Improved solution              0.184 after   24957340 iter,   4801432 nodes (gap 18.4%)
 
Optimal solution               0.184 after   32540920 iter,   5921025 nodes (gap 18.4%).

Relative numeric accuracy ||*|| = 2.22045e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 32540920, 9544798 (29.3%) were bound flips.
      There were 2964565 refactorizations, 0 triggered by time and 4019 by density.
       ... on average 7.8 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 413 NZ entries, 1.1x largest basis.
      The maximum B&B level was 94, 0.2x MIP order, 74 at the optimal solution.
...
Value of objective function: 0.18400000
