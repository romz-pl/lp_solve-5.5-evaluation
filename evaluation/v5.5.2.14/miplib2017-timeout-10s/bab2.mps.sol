...
lp_solve unsuccessful after 3335 iter and a last best value of 1e+30

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 3335, 2203 (66.1%) were bound flips.
      There were 4 refactorizations, 0 triggered by time and 0 by density.
       ... on average 283.0 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 27470 NZ entries, 1.0x largest basis.
      The maximum B&B level was 1, 0.0x MIP order, with 0 nodes explored.
      The constraint matrix inf-norm is 91, with a dynamic range of 91.
      Time to load data was 1.167 seconds, presolve used 0.604 seconds,
       ... 9.400 seconds in simplex solver, in total 11.171 seconds.
Timeout
