...
lp_solve unsuccessful after 6407 iter and a last best value of 1e+30
lp_solve explored 1 nodes before termination

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 6407, 4891 (76.3%) were bound flips.
      There were 6 refactorizations, 0 triggered by time and 1 by density.
       ... on average 252.7 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 4994 NZ entries, 1.0x largest basis.
      ...
      Time to load data was 0.737 seconds, presolve used 0.523 seconds,
       ... 9.480 seconds in simplex solver, in total 10.740 seconds.
Timeout
