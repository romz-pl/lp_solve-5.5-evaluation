...
Optimal solution             5363766 after      33762 iter,      9458 nodes (gap 366.3%).

Relative numeric accuracy ||*|| = 1.45752e-15

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 33762, 2034 (6.0%) were bound flips.
      There were 4579 refactorizations, 0 triggered by time and 1 by density.
       ... on average 6.9 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 5881 NZ entries, 1.0x largest basis.
      The maximum B&B level was 346, 0.3x MIP order, 340 at the optimal solution.
      The constraint matrix inf-norm is 17000, with a dynamic range of 17000.
      Time to load data was 0.009 seconds, presolve used 0.006 seconds,
       ... 9.995 seconds in simplex solver, in total 10.010 seconds.
Suboptimal solution

Value of objective function: 5363766.00000000
