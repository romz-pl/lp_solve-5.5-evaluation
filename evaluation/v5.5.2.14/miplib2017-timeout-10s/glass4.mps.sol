...
Optimal solution          2500019600 after      98856 iter,     53395 nodes (gap 212.5%).

Relative numeric accuracy ||*|| = 2.27152e-16

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 98856, 13945 (14.1%) were bound flips.
      There were 26688 refactorizations, 0 triggered by time and 0 by density.
       ... on average 3.2 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 1357 NZ entries, 1.0x largest basis.
      The maximum B&B level was 85, 0.1x MIP order, 54 at the optimal solution.
