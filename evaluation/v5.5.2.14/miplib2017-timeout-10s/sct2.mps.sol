...
Optimal solution      -198.579730734 after      58670 iter,      5704 nodes (gap 14.0%).

Relative numeric accuracy ||*|| = 2.33147e-15

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 58670, 13260 (22.6%) were bound flips.
      There were 2820 refactorizations, 0 triggered by time and 12 by density.
       ... on average 16.1 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 7088 NZ entries, 1.0x largest basis.
      The maximum B&B level was 162, 0.0x MIP order, 135 at the optimal solution.
      The constraint matrix inf-norm is 146490, with a dynamic range of 1.54587e+07.
      Time to load data was 0.024 seconds, presolve used 0.016 seconds,
       ... 9.985 seconds in simplex solver, in total 10.025 seconds.
Suboptimal solution

Value of objective function: -198.57973073
