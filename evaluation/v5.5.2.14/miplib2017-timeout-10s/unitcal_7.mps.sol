...
lp_solve unsuccessful after 10509 iter and a last best value of 1e+30

 MEMO: lp_solve version 5.5.2.11 for 64 bit OS, with 64 bit REAL variables.
      In the total iteration count 10509, 5397 (51.4%) were bound flips.
      There were 20 refactorizations, 0 triggered by time and 0 by density.
       ... on average 255.6 major pivots per refactorization.
      The largest [LUSOL v2.2.1.0] fact(B) had 80022 NZ entries, 1.0x largest basis.
      The maximum B&B level was 1, 0.0x MIP order, with 0 nodes explored.
      The constraint matrix inf-norm is 1000, with a dynamic range of 1000.
      Time to load data was 0.176 seconds, presolve used 0.084 seconds,
       ... 9.917 seconds in simplex solver, in total 10.177 seconds.
Timeout
